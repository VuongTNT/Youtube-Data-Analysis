...
class YTStatsProMax:
    ...
    # Record scrape time in UTC to match YouTube format
    ...
    def get_channel_category(self):
        ...
        return the most frequent category. This method also serves channel statistics, 
        but we're not using it anymore. Still, we're keeping it here for cross-reference.
        '''
    ...
    def _get_channel_videos(self, limit=None):
        ...
        For example, if the channel_id is: UCeLHszkByNZtPKcaVXOCOQQ
        Then, the popular_playlist_id will be: UULPeLHszkByNZtPKcaVXOCOQQ (change middle C to 'ULP')
        And the popular_short_playlist_id will be: UUPSeLHszkByNZtPKcaVXOCOQQ (change middle C to 'UPS')
        The full upload playlist id is: UUeLHszkByNZtPKcaVXOCOQQ (change middle C to 'U')
...
if __name__ == "__main__":
    ...
    output_directory = 'data/sample_channel_videos_data'
    ...
    for channel_id in channel_ids:
        ...
        # yt.extract_channel_statistics(directory=output_directory) (depreciated)